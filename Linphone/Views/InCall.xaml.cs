...
private async void buttons_VideoClick(object sender, bool isVideoOn) {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs nee) {
            ...
            if (parameters.Count >= 1 && parameters[0].Contains("sip")) {
                ...
                browserSource = $"{browserSource}/CallRespondingAgents/Dashboard?customerPhoneNumber={address.GetCanonicalPhoneNumber()}&IsIncomingCall=true&CallId={BelledonneCommunications.Linphone.ViewModels.DialerViewModel.CallId}&RedirectUrl={browserSource}{BelledonneCommunications.Linphone.ViewModels.DialerViewModel.BrowserCurrentUrlOffset}";
